...
export const tooltips: Partial<Record<TeacherStatsField, string>> = {
  ...
  // ВЕДОМОСТЬ
  lessons_with_homework: 'Количество занятий с заполненным домашним заданием. Рядом указан % от общего количества проведённых занятий',
  lessons_with_files: 'Количество занятий, где есть хотя бы один прикреплённый файл. Рядом указан % от общего количества проведённых занятий',
  scores: 'Количество выставленных оценок. Рядом указан % от максимально возможных: оценки ÷ ((посещ. − проп.) × 3)',
