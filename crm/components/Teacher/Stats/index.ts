...
export const tooltips: Partial<Record<TeacherStatsField, string>> = {
  ...
  client_lessons_absent: 'Пропуски – количество посещений в статусе «не был». Рядом указан % об общего количества посещений',
  client_lessons_late: 'Опоздания – количество посещений в статусах «опоздал» + «опоздал дист.». Рядом указан % об общего количества посещений',
  client_lessons_online: 'Дистанционно – количество посещений в статусах «дист.» + «опоздал дист.». Рядом указан % об общего количества посещений',
