...
class Client extends Person implements HasSchedule
{
    ...
    /**
     * /schedule для ученика
     *
     * 1) Фактически проведенные занятия.
     * 2) Занятия прошедшие без ученика в группе, в которой ученик сейчас присутствует.
     * 3) Отмененные занятия в группе, в которой ученик сейчас присутствует.
     * 4) Планируемые занятия в группе, в которой ученик сейчас присутствует
     */
    public function getLessons(int $year): Collection
    {
        $schedule = collect();
