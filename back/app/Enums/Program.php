...
enum Program: string
{
    ...
    {
        return match ($this) {
            self::bio9 => 'биология (ОГЭ)',
            self::bio10 => 'биология (ЕГЭ)',
            self::bio11 => 'биология (ЕГЭ)',
            self::bioSchool8 => 'биология',
            self::bioSchool9 => 'биология',
            self::bioSchool10 => 'биология (ЕГЭ)',
            self::bioSchool11 => 'биология (ЕГЭ)',
            self::bioExternal => 'биология (ЕГЭ)',
            self::bioOgeSchool9 => 'биология (ОГЭ)',
            self::bioPract => 'биология (практикум)',

            self::chem9 => 'химия (ОГЭ)',
            self::chem10 => 'химия (ЕГЭ)',
            self::chem11 => 'химия (ЕГЭ)',
            self::chemSchool8 => 'химия',
            self::chemSchool9 => 'химия',
            self::chemSchool10 => 'химия (ЕГЭ)',
            self::chemSchool11 => 'химия (ЕГЭ)',
            self::chemExternal => 'химия (ЕГЭ)',
            self::chemOgeSchool9 => 'химия (ОГЭ)',
            self::chemPract => 'химия (практикум)',

            self::eng9 => 'английский язык (ОГЭ)',
            self::eng10 => 'английский язык (ЕГЭ)',
            self::eng11 => 'английский язык (ЕГЭ)',
            self::engSchool8 => 'английский язык',
            self::engSchool9 => 'английский язык',
            self::engSchool10 => 'английский язык (ЕГЭ)',
            self::engSchool11 => 'английский язык (ЕГЭ)',
            self::engExternal => 'английский язык (ЕГЭ)',
            self::engOgeSchool9 => 'английский язык (ОГЭ)',
            self::engPract => 'английский язык (практикум)',
            self::engSpoken => 'разговорный английский',

            self::his9 => 'история (ОГЭ)',
            self::his10 => 'история (ЕГЭ)',
            self::his11 => 'история (ЕГЭ)',
            self::hisSchool8 => 'история',
            self::hisSchool9 => 'история',
            self::hisSchool10 => 'история (ЕГЭ)',
            self::hisSchool11 => 'история (ЕГЭ)',
            self::hisExternal => 'история (ЕГЭ)',
            self::hisOgeSchool9 => 'история (ОГЭ)',
            self::hisPract => 'история (практикум)',

            self::inf9 => 'информатика (ОГЭ)',
            self::inf10 => 'информатика (ЕГЭ)',
            self::inf11 => 'информатика (ЕГЭ)',
            self::infSchool8 => 'информатика',
            self::infSchool9 => 'информатика',
            self::infSchool10 => 'информатика (ЕГЭ)',
            self::infSchool11 => 'информатика (ЕГЭ)',
            self::infExternal => 'информатика (ЕГЭ)',
            self::infOgeSchool9 => 'информатика (ОГЭ)',
            self::infPract => 'информатика (практикум)',

            self::izl9 => 'собеседование',
            self::soch11 => 'сочинение',

            self::lit9 => 'литература (ОГЭ)',
            self::lit10 => 'литература (ЕГЭ)',
            self::lit11 => 'литература (ЕГЭ)',
            self::litSchool8 => 'литература',
            self::litSchool9 => 'литература',
            self::litSchool10 => 'литература (ЕГЭ)',
            self::litSchool11 => 'литература (ЕГЭ)',
            self::litExternal => 'литература (ЕГЭ)',
            self::litOgeSchool9 => 'литература (ОГЭ)',
            self::litPract => 'литература (практикум)',

            self::math9 => 'математика (ОГЭ)',
            self::math10 => 'математика (профиль, ЕГЭ)',
            self::math11 => 'математика (профиль, ЕГЭ)',
            self::mathSchool8 => 'математика',
            self::mathSchool9 => 'математика (ОГЭ)',
            self::mathBaseExternal => 'математика (базовая, ЕГЭ)',
            self::mathProfExternal => 'математика (профиль, ЕГЭ)',
            self::mathBaseSchool10 => 'математика (базовая, ЕГЭ)',
            self::mathProfSchool10 => 'математика (профиль, ЕГЭ)',
            self::mathBaseSchool11 => 'математика (базовая, ЕГЭ)',
            self::mathProfSchool11 => 'математика (профиль, ЕГЭ)',
            self::mathPract => 'математика (профиль, практикум)',

            self::phys9 => 'физика (ОГЭ)',
            self::phys10 => 'физика (ЕГЭ)',
            self::phys11 => 'физика (ЕГЭ)',
            self::physSchool8 => 'физика',
            self::physSchool9 => 'физика',
            self::physSchool10 => 'физика (ЕГЭ)',
            self::physSchool11 => 'физика (ЕГЭ)',
            self::physExternal => 'физика (ЕГЭ)',
            self::physOgeSchool9 => 'физика (ОГЭ)',
            self::physPract => 'физика (практикум)',

            self::rus9 => 'русский язык (ОГЭ)',
            self::rus10 => 'русский язык (ЕГЭ)',
            self::rus11 => 'русский язык (ЕГЭ)',
            self::rusSchool8 => 'русский язык',
            self::rusSchool9 => 'русский язык (ОГЭ)',
            self::rusSchool10 => 'русский язык (ЕГЭ)',
            self::rusSchool11 => 'русский язык (ЕГЭ)',
            self::rusExternal => 'русский язык (ЕГЭ)',
            self::rusPract => 'русский язык (практикум)',

            self::soc9 => 'обществознание (ОГЭ)',
            self::soc10 => 'обществознание (ЕГЭ)',
            self::soc11 => 'обществознание (ЕГЭ)',
            self::socSchool8 => 'обществознание',
            self::socSchool9 => 'обществознание',
            self::socSchool10 => 'обществознание (ЕГЭ)',
            self::socSchool11 => 'обществознание (ЕГЭ)',
            self::socExternal => 'обществознание (ЕГЭ)',
            self::socOgeSchool9 => 'обществознание (ОГЭ)',
            self::socPract => 'обществознание (практикум)',

            self::geo9 => 'география (ОГЭ)',
            self::geo10 => 'география (ЕГЭ)',
            self::geo11 => 'география (ЕГЭ)',
            self::geoSchool8 => 'география',
            self::geoSchool9 => 'география',
            self::geoSchool10 => 'география (ЕГЭ)',
            self::geoSchool11 => 'география (ЕГЭ)',
