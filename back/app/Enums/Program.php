...
enum Program: string
{
    ...
    {
        return match ($this) {
            self::bio10 => 'биология (курсы)',
            self::bio11 => 'биология (курсы)',
            self::bio9 => 'биология (курсы)',
            self::bioExternal => 'биология (экстернат)',
            self::bioOgeSchool9 => 'биология (спецкурс ОГЭ)',
            self::bioPract => 'биология (практикум)',
            self::bioSchool10 => 'биология (старшая школа)',
            self::bioSchool11 => 'биология (старшая школа)',
            self::bioSchool8 => 'биология (старшая школа)',
            self::bioSchool9 => 'биология (старшая школа)',
            self::chem10 => 'химия (курсы)',
            self::chem11 => 'химия (курсы)',
            self::chem9 => 'химия (курсы)',
