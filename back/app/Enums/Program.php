...
enum Program: string
{
    ...
    public function getName(): string
    {
        return match ($this) {
            ...
            self::mathExternal => 'экстернат МАТ',
            self::mathPract => 'практикум МАТ',
            self::mathSchool10 => '10 школа  МАТ',
            self::mathSchool11 => '11 школа МАТ',
    ...
    public function getDirection(): Direction
    {
        return match ($this) {
            ...
            self::mathSchool10 => Direction::school10,
            ...
            self::mathSchool11 => Direction::school11,
            ...
            self::mathExternal => Direction::external,
    ...
    public function getExam(): ?Exam
    {
        return match ($this) {
            ...
            self::mathSchool11 => Exam::egeMathProf,
            self::mathPract => Exam::egeMathProf,
            self::mathExternal => Exam::egeMathProf,
