...
{{ $clientLesson->contractVersionProgram->contractVersion->contract->client->formatName() }} @if ($clientLesson->status === ClientLessonStatus::absent) пропустил(а) урок @elseif (in_array($clientLesson->status, [
