...
<div class="d-flex">
    ...
    <div class="inn-kpp rows">
        <div class="d-flex-center">
            ...
            <div class="box">
                @foreach(str_split(str('622709802712')->padRight(12)) as $char)
                    <div>
                        {{ $char }}
                    </div>
                @endforeach
        ...
        <div class="d-flex-center">
            ...
            <div class="box">
                @foreach(str_split(str('')->padRight(9)) as $char)
                    <div>
                        {{ $char }}
                    </div>
                @endforeach
...
<div class="box mt">
    @foreach(range(1, 40) as $i)
        <div>
            {{ str('Индивидуальный предприниматель Горшкова')->charAt($i - 1) }}
        </div>
    @endforeach
</div>
<div class="box mt-6">
    @foreach(range(1, 40) as $i)
        <div>
            {{ str('Анастасия Александровна')->charAt($i - 1) }}
        </div>
    @endforeach
</div>
...
<div class="d-flex-center mt">
    <div class="box-label" style="width: 85px">
        Фамилия
    </div>
    <div class="box">
...
<div class="d-flex-center mt">
    ...
    <div class="box-label" style="margin-left: 90px">
        Серия и номер
    </div>
    <div class="box">
...
<div class="bottom-zone">
    <div>
        ...
        <div class="box mt">
            @foreach(mb_str_split(str('Горшкова')->padRight(19)) as $char)
                <div>
                    {{$char}}
                </div>
            @endforeach
        ...
        <div class="box mt-6">
            @foreach(mb_str_split(str('Александровна')->padRight(19)) as $char)
                <div>
                    {{$char}}
                </div>
            @endforeach
